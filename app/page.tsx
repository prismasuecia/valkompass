...
export default function HomePage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-xl flex-col justify-center px-5 py-12">
      ...
      <h1 className="mt-4 text-4xl font-semibold tracking-tight text-ink">Valkompass 2026</h1>
      <p className="mt-5 text-lg leading-8 text-slate-700">
        En mobilanpassad valkompass på svenska och spanska. Svara på tio sakfrågor och jämför dina svar med partiernas positioner.
      </p>
